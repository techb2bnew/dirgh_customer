...
export const REGISTER_SUBTITLE =
  'Register your business to access orders, invoices, and your account dashboard.';
export const COMPANY_NAME_LABEL = 'COMPANY NAME';
export const COMPANY_NAME_PLACEHOLDER = 'Meridian Technologies Pvt. Ltd.';
export const COMPANY_NAME_REQUIRED = 'Company name is required';
export const COMPANY_NAME_MIN_LENGTH = 'Company name must be at least 2 characters';
export const CONTACT_NAME_LABEL = 'CONTACT PERSON';
export const CONTACT_NAME_PLACEHOLDER = 'Full name';
export const CONTACT_NAME_REQUIRED = 'Contact person name is required';
export const CONTACT_NAME_MIN_LENGTH = 'Name must be at least 2 characters';
export const ADDRESS_LABEL = 'BUSINESS ADDRESS';
export const ADDRESS_PLACEHOLDER = 'Street, city, state, postal code, country';
export const ADDRESS_REQUIRED = 'Address is required';
export const ADDRESS_MIN_LENGTH = 'Please enter a complete business address';
...
export const PHONE_INVALID = 'Please enter a valid phone number (10–15 digits)';
export const REGISTER = 'Create Account';
export const TERMS_ACCEPT =
  'I agree to the Terms & Conditions and Privacy Policy';
export const TERMS_REQUIRED = 'Please accept the terms and conditions';
export const REGISTER_SUCCESS_TITLE = 'Registration Successful';
export const REGISTER_SUCCESS_MESSAGE =
  'Your business account has been created. Please sign in to continue.';
